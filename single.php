            ...
            <div class="elementor-element e-con e-child">
                <div class="i2g-blog-post">
                    ...
                    <div class="post-image">
                        <img src="<?=$latest_post[0]['image'];?>" alt="Coverphoto" />
                    </div>
                    <div class="row">
                                ...
                                if($latest_post[0]['post']->post_type === 'i2c_reference') {
                                    ?>
                                        <table class="meta-table">
                                            <tr>
                                                ...
                                                <td><?=$latest_post[0]['meta']['referenz_kunde'][0];?></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Zeitraum:</strong></td>
                                                <td><?=$latest_post[0]['meta']['referenz_zeitraum'][0];?></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Branche:</strong></td>
                                                <td>
                                                    &nbsp;<?php
                                                    foreach ($latest_post[0]['categories'] as $cat) {
                                                        $related_categories[] = $cat->term_id;
                                                        echo $cat->name."<br/>";
                                                    }
                                                    ?>
                                                </td>
                                            ...
                                            <tr>
                                                <td><strong>Projekttyp:</strong></td>
                                                <td>
                                                    <?php
                                                    foreach ($latest_post[0]['taxonomies'] as $cat) {
                                                        echo $cat->name."<br/>";
                                                    }
                                                    ?>
                                                </td>
                                    ...
                                    <table class="meta-table">
                                        <tr>
                                            ...
                                            <td><?=date('d.m.Y', strtotime($latest_post[0]['post']->post_date));?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Autor:in:</strong></td>
                                            <td><?=get_the_author_meta('display_name');?></td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="col-md-8 col-sm-12">
                            <div class="post-content">
                                ...
                                <div class="content-body">
                                    <?php
                                    if(!empty($latest_post[0]['meta']['referenz_zitat'])) {
                                        ?>
                                        <div class="reference-quote">
                                            &raquo;<?=$latest_post[0]['meta']['referenz_zitat'][0];?>&laquo;
                                        </div>
                                        <?php
                                    }
                                    ?>
                            ...
                            <?php
                            if($latest_post[0]['post']->post_type === 'i2c_reference') {
                                $posts = get_post_complete(2, 0, get_the_ID(), 'i2g-post-tile-big-size', 'i2c_reference', $related_categories);
                                if(count($posts) > 0) {
                                    ?>
            ...
            <div class="elementor-content-blog-widget">
                <div class="i2g-block-abstract">
                    <div class="content content-center">
                                ...
                                $posts = get_post_complete(2, 0, get_the_ID(), 'i2g-post-tile-big-size', 'post', $related_categories);
                            if(count($posts) > 0) {
                                ?>
        <div class="e-con-inner">
            <div class="elementor-element e-con e-child">
...
<?php get_footer(); ?>
<?php
function get_post_complete($option=1, $post_id=0, $exclude_id=null, $media_size='i2g-post-tile-default-size', $post_type='post', $categories=0) {
    $exclude_ids = [];
    if($exclude_id) {
    ...
    foreach($posts as $post) {
        ...
        $n_post['categories'] = wp_get_post_categories($post->ID, array( 'fields' => 'all' ));
        if($post->post_type === 'i2c_reference') {
            $n_post['taxonomies'] = get_the_terms( $post->ID, 'reference_tags' );
        } else {
            $n_post['taxonomies'] = wp_get_post_tags( $post->ID );
        }
